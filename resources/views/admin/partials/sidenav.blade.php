        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.mining.index',3) }}" href="javascript:void(0)">
                        <i class="menu-icon las la-hammer"></i>
                        <span class="menu-title">@lang('Mining')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.mining.index',2) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.mining.index') }}">
                                <a class="nav-link" href="{{ route('admin.mining.index') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rewards System')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.mining.active') }}">
                                <a class="nav-link" href="{{ route('admin.mining.active') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Mining')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.mining.history') }}">
                                <a class="nav-link" href="{{ route('admin.mining.history') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
