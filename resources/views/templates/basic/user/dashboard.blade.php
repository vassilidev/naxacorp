                        ...
                        <div class="d-widget section--bg2 d-flex flex-wrap align-items-center rounded-3 bg_img h-100" style="background-image: url(' {{ asset($activeTemplateTrue . 'images/elements/card-bg.png') }} ');">
                            <div class="d-widget__content">
                                <h3 class="d-number text-white">
                                    {{ $general->cur_sym }} {{ showAmount(@$widget['total_deposit'],10) }}
                                </h3>
            ...
            @if (@$general->modules->withdraw)
                <div class="col-lg-4 col-md-6">
                    <a href="{{ route('user.withdraw.history') }}" class="w-100 h-100">
                        <div class="d-widget section--bg2 d-flex flex-wrap align-items-center rounded-3 bg_img h-100" style="background-image: url(' {{ asset($activeTemplateTrue . 'images/elements/card-bg.png') }} ');">
                            <div class="d-widget__content">
                                <h3 class="d-number text-white">{{ $general->cur_sym }} {{ showAmount(@$widget['total_withdraw'],10) }}</h3>
                                    ...
                                    <tbody>
                                        @forelse($credits as $credit)
                                            <tr>
                                                ...
                                                <td>{{ __($credit->trx) }}</td>
                                                <td class="fw-bold">
                                                    {{ showAmount($credit->amount,6) }} {{ __($general->cur_text) }}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                    ...
                                    <tbody>
                                        @forelse($debits as $debit)
                                            <tr>
                                                ...
                                                <td>{{ __($debit->trx) }}</td>
                                                <td class="fw-bold">
                                                    {{ showAmount($debit->amount,6) }} {{ __($general->cur_text) }}
                                                </td>
                                                <td class="fw-bold">
                                                    {{ showAmount($debit->charge,6) }} {{ __($general->cur_text) }}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
