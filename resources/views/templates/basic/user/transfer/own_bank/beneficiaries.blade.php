                        ...
                        <div class="my-4">
                            <ul class="caption-list-two p-0">
                                <li>
                                    ...
                                    <span class="value">{{ $general->cur_sym . showAmount($general->minimum_transfer_limit,10) }} (@lang('Min'))</span>
                                </li>

                                <li>
                                    <span class="caption">@lang('Daily Limit')</span>
                                    <span class="value">{{ $general->cur_sym . showAmount($general->daily_transfer_limit,10) }} (@lang('Max'))</span>
                                </li>

                                <li>
                                    <span class="caption">@lang('Monthly Limit')</span>
                                    <span class="value">{{ $general->cur_sym . showAmount($general->monthly_transfer_limit,10) }} (@lang('Max'))</span>
                                </li>
