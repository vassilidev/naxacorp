                ...
                <tbody>
                    @forelse ($transfers as $transfer)
                        <tr>
                            ...
                            <td>{{ $general->cur_sym . showAmount($transfer->amount,10) }}</td>

                            <td>{{ $general->cur_sym . showAmount($transfer->charge,10) }}</td>

                            <td>{{ $general->cur_sym . showAmount($transfer->final_amount,10) }}</td>
