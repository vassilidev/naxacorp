...
<li><a class="" href="https://axireserve.com" target="_blank">@lang('Buy/Sell Naxa')</a></li>
<li> <a class="{{ menuActive('user.mining*') }}" href="{{ route('user.mining.index') }}">@lang('Mining')</a></li>
